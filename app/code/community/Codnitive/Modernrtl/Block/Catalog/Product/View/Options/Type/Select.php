 ...
 * @author     Hassan Barza <support@codnitive.com>
 */
class Codnitive_Modernrtl_Block_Catalog_Product_View_Options_Type_Select
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_RADIO
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $selectHtml .= '<li>' . '<input type="' . $type . '" class="' . $class . ' ' . $require
                    ...
                    . '<span class="label"><label for="options_' . $_option->getId() . '_' . $count . '"><span class="product-option-title">'
                    . $_value->getTitle() . '</span> ' . $priceStr . '</label></span>';
                if ($_option->getIsRequire()) {
